...
{
    /// <inheritdoc />
    public partial class Added_Departments_And_DataDictionaries : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Leader = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppDictionaryItems", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppDictionaryItems_DictionaryTypeId_IsEnabled",
                table: "AppDictionaryItems",
                columns: new[] { "DictionaryTypeId", "IsEnabled" });

            migrationBuilder.CreateIndex(
                name: "IX_AppDictionaryTypes_Code",
